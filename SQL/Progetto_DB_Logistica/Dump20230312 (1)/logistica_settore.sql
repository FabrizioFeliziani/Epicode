...
CREATE TABLE `settore` (
  `id_settore` tinyint NOT NULL AUTO_INCREMENT,
...
INSERT INTO `settore` VALUES (1,'trasporto locale','trasporto sotto le 3,5 tonnellate'),(2,'trasporto straordinario','trasporto sopra le 3,5 tonnettate'),(3,'trasporto speciale','trasporto materiale liquido e/o rischio infiammabilità');
